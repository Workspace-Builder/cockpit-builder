...
//
// E comportam menos ITENS: uma vaga, um item. A conferência de 2026-07-31
// contra o legado e contra os comentários da task 86ajqczg6 achou 9 entregáveis
// que tinham sumido por isso — 6 deles só no Pilar 04. Oito voltaram por `dentro`
// (ver `Vaga` em model.ts): eram nomes que apontavam pro MESMO destino da vaga
// que os engoliu, então nunca precisaram de vaga própria, precisavam aparecer.
// O nono, "Suporte na ferramenta" (Pedir ajuda quando trava), leva a outro
// lugar e continua de fora — esse é vaga de verdade e espera decisão.
// ---------------------------------------------------------------------------
...
export const PASSOS: Passo[] = [
  ...
  // --- PILAR 01 · ENTREGA ---------------------------------------------
  { id: "estrategia-da-pagina", paginaId: "obra", pilar: 1, ordem: 1, titulo: "Estratégia da página", sub: "O que ela precisa ter pra converter — decidido antes de abrir ferramenta.", e8020: true, cicloPos: 4, unha: false, ia: { label: "IA 05 Estrutura de Sites", url: "https://app.easybuilder.com.br/ferramentas" } },
  { id: "copy", paginaId: "obra", pilar: 1, ordem: 2, titulo: "Copy", sub: "O texto que vende. Design bom não salva copy fraca.", e8020: true, cicloPos: 5, unha: false, ia: { label: "IA 06 Easy Copy", url: "https://app.easybuilder.com.br/ferramentas" } },
  { id: "design", paginaId: "obra", pilar: 1, ordem: 3, titulo: "Design", sub: "Direção com intenção: arquétipo, paleta, tipografia. Nunca do zero.", e8020: true, cicloPos: 6, unha: false, aula: { label: "Design Easy", url: "https://easybuilder.club/" }, ia: { label: "IA 09 Diretor Criativo", url: "https://app.easybuilder.com.br/ferramentas" }, ferram: { label: "Extensão EB · 1.000+ componentes", url: "https://app.easybuilder.com.br/index-v2/paginas?tipo=links", plat: "EB" } },
  { id: "imagem-e-direcao-visual", paginaId: "obra", pilar: 1, ordem: 4, titulo: "Imagem e direção visual", e8020: false, cicloPos: null, unha: false, ia: { label: "IA 10 Easy Image", url: "https://app.easybuilder.com.br/ferramentas" } },
  { id: "codigo-e-efeitos", paginaId: "obra", pilar: 1, ordem: 5, titulo: "Código e efeitos", sub: "O acabamento que separa página de página cara.", e8020: true, cicloPos: 7, unha: false, ia: { label: "IA 11 Easy Coder", url: "https://app.easybuilder.com.br/ferramentas" } },
  ...
  { id: "qualidade-antes-de-enviar", paginaId: "obra", pilar: 1, ordem: 9, titulo: "Qualidade antes de enviar", sub: "O gate: a página só sai quando passa. Protege preço e reputação.", e8020: true, cicloPos: 9, unha: false, ia: { label: "IA 12 Analisador de Páginas", url: "https://app.easybuilder.com.br/ferramentas" } },

  // --- PILAR 02 · VALOR PERCEBIDO ---------------------------------------------
  { id: "posicionamento", paginaId: "obra", pilar: 2, ordem: 1, titulo: "Posicionamento", sub: "1 frase: quem você atende e o que entrega. Vira bio, portfólio e conteúdo.", e8020: true, cicloPos: null, unha: false, aula: { label: "Anti Prospecção", url: "https://easybuilder.club/" }, ia: { label: "IA 02 ICP e Posicionamento", url: "https://app.easybuilder.com.br/ferramentas" } },
  ...
  { id: "instagram", paginaId: "obra", pilar: 2, ordem: 3, titulo: "Instagram", sub: "Bio que diz o que você faz, grid de projeto, busca te achando.", e8020: false, cicloPos: null, unha: false, aula: { label: "Reels N3 + SEO", url: "https://easybuilder.club/" }, ia: { label: "IA 07 Copy Carrossel", url: "https://app.easybuilder.com.br/ferramentas" }, ferram: { label: "Template Carrossel", url: "https://app.easybuilder.com.br/index-v2/paginas?tipo=links", plat: "EB" } },
  { id: "plano-de-negocio", paginaId: "obra", pilar: 2, ordem: 4, titulo: "Plano de negócio", sub: "Saber onde está e o que atacar.", e8020: false, cicloPos: null, unha: false, ia: { label: "IA 01 Análise Estratégica", url: "https://app.easybuilder.com.br/ferramentas" }, ferram: { label: "O Plano [10k26/27]" } },
  { id: "atendimento", paginaId: "obra", pilar: 2, ordem: 5, titulo: "Atendimento", sub: "Investiga antes de dar preço. Conversa conduzida até o sim.", e8020: true, cicloPos: 1, unha: false, aula: { label: "Easy Sales", url: "https://easybuilder.club/" }, ia: { label: "IA 03 Atendimento e Negociação", url: "https://app.easybuilder.com.br/ferramentas", dentro: [{ label: "IA 04 Webson Vendedor" }] } },
  ...
  { id: "trafego-pago-nitro", paginaId: "obra", pilar: 2, ordem: 11, titulo: "Tráfego pago · nitro", sub: "Só se quiser acelerar. R$10/dia já valida.", e8020: false, cicloPos: null, unha: false, aula: { label: "Tráfego N3", url: "https://easybuilder.club/" }, ia: { label: "IA 08 Copy Ads", url: "https://app.easybuilder.com.br/ferramentas" } },

  // --- PILAR 03 · GESTÃO ---------------------------------------------
  { id: "onboarding-do-cliente", paginaId: "obra", pilar: 3, ordem: 1, titulo: "Onboarding do cliente", sub: "Todo projeto entra pelo mesmo trilho. Começo padrão mata refação.", e8020: true, cicloPos: 3, unha: false, ferram: { label: "Formulário de Briefing", url: "https://app.easybuilder.com.br/index-v2/paginas?tipo=links", plat: "EB", dentro: [{ label: "Template de Proposta" }, { label: "Template de Contrato" }] } },
  ...
  { id: "projetar-crescimento", paginaId: "obra", pilar: 3, ordem: 7, titulo: "Projetar crescimento", sub: "Projetos × ticket: as duas alavancas do 10k, todo mês.", e8020: false, cicloPos: null, unha: false, ia: { label: "IA 01 Análise Estratégica", url: "https://app.easybuilder.com.br/ferramentas" }, ferram: { label: "Planilha Financeira", url: "https://app.easybuilder.com.br/index-v2/paginas?tipo=links", plat: "EB" } },
  ...
  { id: "estar-no-ambiente-certo", paginaId: "obra", pilar: 4, ordem: 3, titulo: "Estar no ambiente certo", sub: "Lugar onde vender página de R$3.000 a R$8.000 é o normal — a visão de mercado muda por osmose.", e8020: false, cicloPos: null, unha: false, ferram: { label: "Comunidade WhatsApp", url: "https://easybuilder.club/", dentro: [{ label: "Discord" }, { label: "Nichos" }, { label: "Behance" }] } },
  ...
  { id: "acessar-mentes-que-construiram", paginaId: "obra", pilar: 4, ordem: 5, titulo: "Acessar mentes que construíram", sub: "Atalho de década: 14 mentorias gravadas + 1 nova todo mês com especialistas.", e8020: false, cicloPos: null, unha: false, ferram: { label: "Mentorias mensais", url: "https://easybuilder.club/", dentro: [{ label: "Lucas Neves · vendas gringa" }, { label: "Luan Shimoda · tráfego" }, { label: "Lorenzi · dentro da comunidade" }] } },
  { id: "networking-e-oportunidades", paginaId: "obra", pilar: 4, ordem: 6, titulo: "Networking e oportunidades", sub: "Indicação de trabalho, parceria fechada, proposta circulando dentro da própria comunidade.", e8020: false, cicloPos: null, unha: false, ferram: { label: "Indicações e parcerias", url: "https://easybuilder.club/", dentro: [{ label: "Expor projeto no Behance / Nichos" }] } },
...
/**
 * A página que a Obra desenha — é o `paginaId` dos 36 passos acima.
 *
 * Existe como constante porque três lugares precisam reconhecer essa página
 * para tratá-la diferente (a rota carrega o 80/20, o palco troca o canvas pelo
 * quarteirão, a casca esconde o dock). Três literais `"obra"` soltos é como um
 * deles fica pra trás no dia da renomeação.
 */
export const ID_OBRA = "obra";

/**
 * O Motor de Tijolos: a roda do funil anti-prospecção, com o arsenal por setor.
 * É a "página do flywheel" do BLUEPRINT-PAGINAS §9 (ordem 4) — o id, o nome da
 * página e o título da tela dizem a mesma palavra de propósito.
 */
export const ID_MOTOR = "motor";
...
/* `passos8020()` foi removido junto com a mudança de significado (migration
   009). Filtrar 18 dos 36 andares como "os que importam" era a divergência:
   todo andar é obrigatório. Quando a vista 80/20 do Trilho existir, ela filtra
   ENTREGÁVEL marcado — dado do banco, via `listarOitentaVinte()` — e não este
   campo, que hoje só desenha relevo na laje. */
