...
export const PASSOS: Passo[] = [
  ...
  { id: "atendimento", paginaId: "obra", pilar: 2, ordem: 5, titulo: "Atendimento", sub: "Investiga antes de dar preço. Conversa conduzida até o sim.", e8020: true, cicloPos: 1, unha: false, aula: { label: "Easy Sales", url: "https://easybuilder.club/" }, ia: { label: "IA 03 Atendimento e Negociação", url: "https://app.easybuilder.com.br/ferramentas", dentro: ["IA 04 Webson Vendedor"] } },
  ...
  // --- PILAR 03 · GESTÃO ---------------------------------------------
  { id: "onboarding-do-cliente", paginaId: "obra", pilar: 3, ordem: 1, titulo: "Onboarding do cliente", sub: "Todo projeto entra pelo mesmo trilho. Começo padrão mata refação.", e8020: true, cicloPos: 3, unha: false, ferram: { label: "Formulário de Briefing", url: "https://app.easybuilder.com.br/index-v2/paginas?tipo=links", plat: "EB", dentro: ["Template de Proposta", "Template de Contrato"] } },
  ...
  { id: "acessar-mentes-que-construiram", paginaId: "obra", pilar: 4, ordem: 5, titulo: "Acessar mentes que construíram", sub: "Atalho de década: 14 mentorias gravadas + 1 nova todo mês com especialistas.", e8020: false, cicloPos: null, unha: false, ferram: { label: "Mentorias mensais", url: "https://easybuilder.club/", dentro: ["Lucas Neves · vendas gringa", "Luan Shimoda · tráfego", "Lorenzi · dentro da comunidade"] } },
  { id: "networking-e-oportunidades", paginaId: "obra", pilar: 4, ordem: 6, titulo: "Networking e oportunidades", sub: "Indicação de trabalho, parceria fechada, proposta circulando dentro da própria comunidade.", e8020: false, cicloPos: null, unha: false, ferram: { label: "Indicações e parcerias", url: "https://easybuilder.club/", dentro: ["Expor projeto no Behance / Nichos"] } },
